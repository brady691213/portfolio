...
endDate: 2018-06-30
description: Involved in two notable projects. Firstly, implemented an interface between 2 Realty listing systems. Tasked with developing a WCF client for one API, I managed complex data transfer between the two, necessitating intricate mapping between disparate data structures and flows. Secondly, contributed to the backend development of an online cashless betting system tailored for golfers. While the service has since evolved, I played a pivotal role in implementing its initial availability. The system, known as PayCaddy®, can be accessed at https://www.paycaddy.co.za
highlights:
